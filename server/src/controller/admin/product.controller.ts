...
export const createProduct = asyncHandler(async (req: Request, res: Response) => {
  ...
  if (user.role !== "admin") throw new ApiError(403, "Only admins can create products");
...
export const updateProduct = asyncHandler(async (req: Request, res: Response) => {
  ...
  const user = await User.findById(userId);
  if (!user) throw new ApiError(404, "User not found");
  if (user.role !== "admin") throw new ApiError(403, "Only admins can update products");
...
export const deleteProduct = asyncHandler(async (req: Request, res: Response) => {
  ...
  const user = await User.findById(userId);
  if (!user) throw new ApiError(404, "User not found");
  if (user.role !== "admin") throw new ApiError(403, "Only admins can delete products");
...
export const getMyProducts = asyncHandler(async (req: Request, res: Response) => {
  ...
  if (userRole !== "admin") throw new ApiError(403, "Only admins can access their products");
